...
/**     Credentials - I took inspiration from
        * My reviewer's technical input:
        * blogs -
        *  https://howtodoinjava.com/spring-boot2/testing/spring-boot-mockmvc-example
        * forums -
        *  https://stackoverflow.com/questions/49846627/how-to-correctly-mock-a-websocket-session
        *
        * @Author - Kalyani Tiwari (integration of all inputs from the course and above mentioned sources)
...
public class TestWebSocketChatApplication {
    ...
    public void join() throws Exception{
        String request = "/?username=Kalyani";
        mockMvc.perform(MockMvcRequestBuilders
    ...
    public void chat() throws Exception{
        ...
        message.setFrom("Kalyani");
        message.setContent("Knock! knock! anybody there??");
